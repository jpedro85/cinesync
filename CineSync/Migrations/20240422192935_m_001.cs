...
{
    /// <inheritdoc />
    public partial class m_001 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingCS = table.Column<float>(type: "decimal(3,1)", nullable: false),
                    Rating = table.Column<float>(type: "decimal(3,1)", nullable: false),
                    PosterImage = table.Column<byte[]>(type: "BLOB", nullable: false),
                    Overview = table.Column<string>(type: "TEXT", nullable: true),
                    ReleaseDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Cast = table.Column<string>(type: "TEXT", nullable: true),
                    TrailerKey = table.Column<string>(type: "TEXT", nullable: true),
                    Director = table.Column<string>(type: "TEXT", nullable: true),
                    Awards = table.Column<string>(type: "TEXT", nullable: true),
                    RunTime = table.Column<short>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfLikes = table.Column<long>(type: "INTEGER", nullable: false),
                    NumberOfDeslikes = table.Column<long>(type: "INTEGER", nullable: false),
                    MovieId = table.Column<uint>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Discutions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoviesId = table.Column<uint>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscussionId = table.Column<uint>(type: "INTEGER", nullable: true),
                    MovieId = table.Column<uint>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Discutions_DiscussionId",
